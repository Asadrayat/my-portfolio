    ...
    return (
        <div className="hero">
            <div className="hero-content flex-col lg:flex-row">
                <div className="flex w-2/4 flex-col flex-50-gt-sm waypoint animated slide-in-left">
                    <img src={pic} className="rounded-lg lg:w-3/4shadow-2xl  mask mask-squircle" alt='' />
                    <div>
